...
void loop() 
{
  ...
  if (len > 0) 
  {
    ...
    if (printWebData) Serial.write(buffer, len); // show in the serial monitor (slows some boards)
  ...
  if (!client.connected()) 
  {
    ...
    client.stop();
    Serial.print("Received "); Serial.print(byteCount); Serial.print(" bytes in ");
    float seconds = (float)(endMicros - beginMicros) / 1000000.0;
    Serial.print(seconds, 4);
    float rate = (float)byteCount / seconds / 1000.0;
    Serial.print(", rate = "); Serial.print(rate); Serial.print(" kbytes/second");
    Serial.println();
