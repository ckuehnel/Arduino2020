/*
 * File: M5StickC_GMC_Gravity.ino
 * 
 * Program for Geiger-Müller-Counter DFRobot Gravity collects GMC pulses and calculates CPM and uSv/h
...
{
  M5.begin();
  Serial.printf("\nReading Gravity GMC connected to M5StickC G26\n");
  initLCD();
  initWiFi();
