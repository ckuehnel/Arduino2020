/*
 * File: PaperiNode_DevEUI.ino
 * 
 * Prints the DevEUI of PaperiNode to the Console. 
 * You need the DevEUI for registration at TTN.
 * 
 * Based on https://github.com/RobPo/PaperiNode/tree/master/examples/01_SerialPrintDevEUI
 */
