...
#define STRUCT_H
	...
	*/
	...
	typedef struct 
	{
		...
		bool 				Channel_Hopping_enabled = true;							//	Enables channel hopping when set to true, the channel won't be changed when set to false		
		...
		{
		  .NwkSKey = { 0x26, 0x2A, 0x4E, 0xAB, 0x27, 0xA8, 0x76, 0xAF, 0xD2, 0xCD, 0xEF, 0x80, 0xB7, 0x61, 0x19, 0x7B },	// Change this to your own key
      .AppSKey = { 0xDC, 0x9E, 0x29, 0xA4, 0xC7, 0xC4, 0x94, 0x9F, 0xC8, 0xF3, 0x04, 0x74, 0x51, 0xCE, 0x62, 0x20 },	// Change this to your own key
		  .DevAddr = { 0x26, 0x01, 0x38, 0x61 },																			// Change this to your own key
		...
		sLoRa_OTAA OTAA =
		{
			.DevEUI   = { 0x01, 0xD0, 0x3F, 0x24, 0x1C, 0x00, 0x00, 0x9D },		//	If the DS2401 is used, set the DEV EUI to zero.
			.AppEUI   = {0x01, 0x23, 0x45, 0x67, 0x89, 0x10, 0x12, 0x34},   	//  TTN Ideetron Application EUI, change this to your own APP EUI code
			.AppKey   = {0x01, 0x23, 0x45, 0x67, 0x89, 0x10, 0x12, 0x34, 0x56, 0x78, 0x90, 0x12, 0x34, 0x56, 0x78, 0x90},
			.DevNonce = {0},
			.AppNonce = {0},
			.NetID    = {0},
			.OTAAdone = false,
