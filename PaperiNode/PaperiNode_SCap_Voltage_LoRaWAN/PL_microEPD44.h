...
#define ADDR_PIC1         0         // Adress of Pic1..Pic7
#define ADDR_PIC2         8192
#define ADDR_PIC3         16384
#define ADDR_PIC4         24576
#define ADDR_PIC5         32768
#define ADDR_PIC6         40960
#define ADDR_PIC7         49152
#define ADDR_FRAMEBUFFER  57344     // Reserved for saving framebuffer content during power-poff
...
public:
    ...
    void saveFBToFlash(int address=ADDR_FRAMEBUFFER);
    void saveImgToFlash(int address=ADDR_PIC1);
